     ...
     const submit = async (e) => {
       ...
       try {
         const response = await axios.post(
           "https://frankizah.pythonanywhere.com/api/addproduct",
           data
         );
    ...
    <div className="row justify-content-center mt-2 y">
      <div className="col-md-6 card shadow p-4">
        <form onSubmit={submit}>
          ...
          <input type="text" className="form-control" placeholder="Enter the Shoe Name" 
          value={product_name} onChange={(e) => setProductName(e.target.value)} />
          <br />
          {/* {product_name} */}
          <textarea placeholder="Enter some Description of the shoe" className="form-control" value={product_description}
          onChange={(e) => setProductDescription(e.target.value)}></textarea> <br />
          {/* {product_description} */}
          <input type="number" placeholder="Enter the price of the shoe" className="form-control"
